...
public class WebTesting {
	...
	public static void initSystemProperties() {
		...
		Path currentRelativePath = Paths.get("/drivers/geckodriver.exec");

		String geckoPath = Paths.get(currentRelativePath.toAbsolutePath().toString(), "drivers/geckodriver.exec").toString();
		geckoPath = geckoPath.replace("\\", "/");
		System.out.println(geckoPath);
		
		String chromePath = Paths.get(currentRelativePath.toAbsolutePath().toString(), "drivers/chromedriver.exec").toString();
